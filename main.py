...
data = {"weather":{"value":wea},"temperature":{"value":temperature,"color": "#FF0000" if temperature > 30 else "#00FF00"},"low":{"value":low},"high":{"value":high},"humidity":{"value":humidity},"wind":{"value":wind},"air":{"value":air,"color":"#00FF00" if air.strip()=="优".strip() else "#FF9900"},"love_days":{"value":get_count()},"birthday_left":{"value":get_birthday()},"words":{"value":get_words(), "color":get_random_color()},"words2":{"value":text+' —— '+ author, "color":get_random_color2()}}
